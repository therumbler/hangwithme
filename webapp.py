...
STATIC_DIRECTORY = os.path.join(ROOT, "static")

logger = logging.getLogger(__name__)

async def index(request):
    content = open(os.path.join(STATIC_DIRECTORY, "index.html"), "r").read()
    return web.Response(content_type="text/html", text=content)


async def javascript(request):
    content = open(os.path.join(STATIC_DIRECTORY, "client.js"), "r").read()
